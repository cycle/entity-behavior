# Contributing
Feel free to contribute to the development of the Cycle ORM Entity Behavior.
...
## Testing Cycle ORM Entity Behavior
To test Cycle ORM Entity Behavior locally, download the `cycle/entity-behavior` repository and start docker containers inside the tests folder:
...
## Official Support
Cycle ORM Entity Behavior are maintained by [Spiral Scout](https://spiralscout.com/).

For commercial support please contact team@spiralscout.com.

## Licensing
Cycle ORM Entity Behavior will remain under [MIT license](/LICENSE) indefinitely.
