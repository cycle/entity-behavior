...
$integrationDir = __DIR__ . '/Behavior/Functional/Driver/Common/Integration';
...
{
    $caseTemplateDir = __DIR__ . '/Behavior/Functional/Driver/Common/Integration/' . $caseTemplateDirName;
